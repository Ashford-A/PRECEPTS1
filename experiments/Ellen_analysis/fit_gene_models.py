...
from HetMan.experiments.Ellen_analysis.cohorts import CancerCohort
...
def main():
    ...
    cdata = CancerCohort(
        ...
        toil_dir=toil_dir, sample_data=ellen_data, syn=syn, copy_dir=copy_dir,
        annot_file=annot_file, cv_seed=(args.cv_id * 59) + 121, cv_prop=1.0
        )

    ellen_samps = {samp for samp in cdata.samples if samp[:4] != 'TCGA'}
    ...
    for mtype in test_mtypes:
        ...
        mut_clf.tune_coh(
            cdata, mtype,
            exclude_genes=ex_genes, exclude_samps=ellen_samps,
